...
<!-- Hero Section Start -->
<section class="hero-section fix hero-1 bg-cover" style="background-image: url('img/hero/hero-bg.jpg');">
    <div class="mike-shape">
        <img src="{{ asset('img/hero/mike-shape.png') }}" alt="img">
    </div>
    <div class="arrow-shape">
        <img src="{{ asset('img/hero/arrow-shape.png') }}" alt="img">
    </div>
    <div class="arrow-shape-2">
        <img src="{{ asset('img/hero/arrow-shape.png') }}" alt="img">
    </div>
    <div class="energy-shape float-bob-y">
        <img src="{{ asset('img/hero/energy-shape.png') }}" alt="img">
    </div>
    <div class="rocket-shape">
        <img src="{{ asset('img/hero/rocket.png') }}" alt="img" class="float-bob-y">
    </div>
    <div class="container-fluid">
        <div class="hero-title wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
            <img src="{{ asset('img/hero-text.png') }}" alt="img"> 
        ...
        <div class="row g-4 align-items-center">
            ...
            <div class="col-xl-4 col-lg-6">
                <div class="hero-image">
                    <img src="{{ asset('img/hero/hero-image.png') }}" alt="img" class=" wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div class="bg-shape">
                        <img src="{{ asset('img/hero/bg-shape.png') }}" alt="img">
                    </div>
                </div>
            </div>
                ...
                <div class="video-right">
                    ...
                    <div class="client-items wow fadeInUp" data-wow-delay=".7s">
                        <div class="client-logo">
                            <img src="{{ asset('img/hero/client.png') }}" alt="img">
                        </div>
...
<div class="marquee-section-1">
    <div class="mycustom-marque style-2">
        <div class="scrolling-wrap">
            <div class="comm">
                <div class="cmn-textslide"><img src="{{ asset('img/star.png') }}" alt="img">THE BEST SOULTION</div>
                <div class="cmn-textslide"><img src="{{ asset('img/star.png') }}" alt="img">THE BEST SOULTION</div>
                <div class="cmn-textslide"><img src="{{ asset('img/star.png') }}" alt="img">THE BEST SOULTION</div>
                <div class="cmn-textslide"><img src="{{ asset('img/star.png') }}" alt="img">THE BEST SOULTION</div>
                <div class="cmn-textslide"><img src="{{ asset('img/star.png') }}" alt="img">THE BEST SOULTION</div>
...
<section class="service-section fix section-padding" id="services">
    <div class="left-shape float-bob-y">
        <img src="{{ asset('img/service/left-shape.png') }}" alt="img">
    </div>
    <div class="right-shape">
        <img src="{{ asset('img/service/right-shape.png') }}" alt="img">
    </div>
    <div class="bg-shape">
        <img src="{{ asset('img/service/bg-shape.png') }}" alt="img">
    </div>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="{{ asset('img/service/icon-1.png') }}" alt="img">
                    </div>
                    <div class="content"> 
                        <h4><a href="{{ route('service.details') }}">Digital Marketing</a></h4>
                        <p>Lorem dolor amet consectetur read adipiscing any more elit.</p>
                        <a href="{{ route('service.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="{{ asset('img/service/icon-2.png') }}" alt="img">
                    </div>
                    <div class="content"> 
                        <h4><a href="{{ route('service.details') }}">SEO Analytics</a></h4>
                        <p>Lorem dolor amet consectetur read adipiscing any more elit.</p>
                        <a href="{{ route('service.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                    </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                <div class="service-box-items">
                    <div class="icon">
                        <img src="{{ asset('img/service/icon-3.png') }}" alt="img">
                    </div>
                    <div class="content"> 
                        <h4><a href="{{ route('service.details') }}">Social Marketing</a></h4>
                        <p>Lorem dolor amet consectetur read adipiscing any more elit.</p>
                        <a href="{{ route('service.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                    </div>
                </div>
...
<!-- About Section Start -->
<section class="about-section fix section-padding" style="background-image: url('img/about/about-bg.png');" id="about">
    <div class="left-shape float-bob-y">
        <img src="{{ asset('img/about/left-shape.png') }}" alt="img">
    </div>
    <div class="container">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="brand-img center">
                            <img src="{{ asset('img/brand/01.png') }}" alt="img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-img center">
                            <img src="{{ asset('img/brand/02.png') }}" alt="img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-img center">
                            <img src="{{ asset('img/brand/03.png') }}" alt="img">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-img center">
                            <img src="{{ asset('img/brand/04.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="about-image">
                        <img src="{{ asset('img/brand/01.png') }}" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <div class="bg-shape">
                            <img src="{{ asset('img/brand/bg-shape.png') }}" alt="img">
                        </div>
                        <div class="grap-shape float-bob-x">
                            <img src="{{ asset('img/brand/grap.png') }}" alt="img">
                        </div>
                        <div class="box-shape float-bob-y">
                            <img src="{{ asset('img/about/box-shape.png') }}" alt="img">
                        </div>
                        <div class="emoji-shape">
                            <img src="{{ asset('img/about/emoji.png') }}" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
...
<section class="case-study-section fix section-padding" id="projects">
    <div class="overlay-shape">
        <img src="{{ asset('img/case-studies/overlay-shape.png') }}" alt="img">
    </div>
    <div class="left-shape float-bob-x">
        <img src="{{ asset('img/case-studies/left-shape.png') }}" alt="img">
    </div>
            ...
            <div class="row">
                <div class="col-xxl-6 wow fadeInUp">
                    <div class="case-study-box-items">
                        <div class="thumb">
                            <img src="{{ asset('img/case-studies/01.jpg') }}" alt="img">
                            <div class="post-box-items">
                                <ul>
                                    <li>
                                        <a href="{{ route('project.details') }}">Real-time Analytics <i class="fa-regular fa-arrow-up-right"></i></a>
                                    </li>
                                    <li>
                                        <a href="{{ route('project.details') }}">Social <i class="fa-regular fa-arrow-up-right"></i></a>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <a href="{{ route('project.details') }}">Agile Advance <i class="fa-regular fa-arrow-up-right"></i></a>
                                    </li>
                                    <li>
                                        <a href="{{ route('project.details') }}">Advance <i class="fa-regular fa-arrow-up-right"></i></a>
                                    </li>
                                </ul>
                            </div>
                            <h3 class="project-title">
                                <a href="{{ route('project.details') }}">
                                    <img src="{{ asset('img/case-studies/icon.png') }}" alt="img">
                    ...
                    <div class="main-box">
                        <div class="box wow fadeInUp">
                            ...
                            <div class="project-content">
                                ...
                                <a href="{{ route('project.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            </div>
                        </div>
                        <div class="box bg-1 wow fadeInUp wow" data-wow-delay=".2s">
                            <div class="title-items">
                                <h3><a href="{{ route('project.details') }}">Instantly Analyze</a></h3>
                        ...
                        <div class="box bg-2 active wow fadeInUp wow" data-wow-delay=".4s">
                            <div class="title-items">
                                <h3><a href="{{ route('project.details') }}">Web & Mobile</a></h3>
                        ...
                        <div class="box bg-3 wow fadeInUp wow" data-wow-delay=".6s">
                            <div class="title-items">
                                <h3><a href="{{ route('project.details') }}">Email marketing</a></h3>
...
<section class="audience-section fix section-padding bg-cover" style="background-image: url('assets/img/audience-bg.jpg');">
    <div class="container">
                ...
                <div class="col-lg-4">
                    <div class="audience-content">
                        ...
                        <div class="client-items wow fadeInUp" data-wow-delay=".5s">
                            <div class="client-logo">
                                <img src="{{ asset('img/hero/logo.png') }}" alt="img">
                            </div>
                            <div class="client-img">
                                <img src="{{ asset('img/hero/client.png') }}" alt="img">
                                <div class="star-icon">
                ...
                <div class="col-lg-8">
                    <div class="audience-right">
                        <div class="audience-img wow fadeInUp" data-wow-delay=".3s">
                            <img src="{{ asset('img/audience-img.jpg') }}" alt="img">
                        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="team-image">
                        <img src="{{ asset('img/team/01.png') }}" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
...
<section class="pricing-section fix section-padding section-bg">
    <div class="left-shape float-bob-y">
        <img src="{{ asset('img/pricing-left.png') }}" alt="img">
    </div>
    <div class="right-shape float-bob-y">
        <img src="{{ asset('img/pricing-right.png') }}" alt="img">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-xl-4">
                <div class="pricing-content">
                    ...
                    <div class="pricing-tab-header mt-4 mt-md-0">
                        <div class="arrow-shape">
                            <img src="{{ asset('img/arrow.png') }}" alt="img">
                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                                <div class="pricing-box-items style-2">
                                    <div class="pricing-header">
                                        ...
                                        <div class="icon">
                                            <img src="{{ asset('img/cloud.png') }}" alt="img">
                                        </div>
                                    </div>
                                    <ul class="price-list">
                                        <li>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="testimonial-box-items">
                                    <div class="icon">
                                        <img src="{{ asset('img/testimonial/icon.png') }}" alt="img">
                                    </div>
                                    <div class="testimonial-img">
                                        <img src="{{ asset('img/testimonial/01.png') }}" alt="img">
                                        <div class="shape-img">
                                            <img src="{{ asset('img/testimonial/shape.png') }}" alt="img">
                                        </div>
                                    </div>
                                    <div class="content">
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-box-items">
                                    ...
                                    <div class="testimonial-img">
                                        <img src="{{ asset('img/testimonial/02.png') }}" alt="img">
                                        <div class="shape-img">
                                            <img src="{{ asset('img/testimonial/shape.png') }}" alt="img">
                                        </div>
                                    </div>
...
<!-- News Section Start -->
<section class="news-section section-padding section-bg" id="blog">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="news-box-items">
                    ...
                    <div class="news-content">
                        ...
                        <h5><a href="{{ route('news.details') }}">Importers achieve savings through the First Sale rule!</a></h5>
                        <div class="news-btn">
                            <a href="{{ route('news.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            <img src="{{ asset('img/news/client-img.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="news-box-items">
                    <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.4s">
                        <img src="{{ asset('img/news/02.jpg') }}" alt="img">
                    </div>
                    <div class="news-content">
                        <ul class="post-cat">
                            <li>
                        ...
                        <h5><a href="{{ route('news.details') }}">Is now the right time to invest in an enterprise</a></h5>
                        <div class="news-btn">
                            <a href="{{ route('news.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="news-box-items">
                    <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.6s">
                        <img src="{{ asset('img/news/03.jpg') }}" alt="img">
                    </div>
                    <div class="news-content">
                        <ul class="post-cat">
                            <li>
                        ...
                        <h5><a href="{{ route('news.details') }}">Focus logistics secure new 
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="news-box-items">
                    <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.8s">
                        <img src="{{ asset('img/news/04.jpg') }}" alt="img">
                    </div>
                    <div class="news-content">
                        <ul class="post-cat">
                            <li>
                        ...
                        <h5><a href="{{ route('news.details') }}">Transid Named a Finalist For Year’ 25 Best Choice </a></h5>
                        <div class="news-btn">
                            <a href="{{ route('news.details') }}" class="link-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                            <img src="{{ asset('img/news/client-img.png') }}" alt="img">
                        </div>
