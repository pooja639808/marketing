        ...
        <div class="row g-4 justify-content-between align-items-center">
            ...
            <div class="col-lg-5">
                <div class="hero-image">
                    <img src="assets/img/hero/hero-image-2.png" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div class="bg-shape">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                <div class="feature-box-image bg-cover" style="background-image: url('assets/img/feature-bg.jpg');">
...
<section class="cta-counter-section fix section-padding pt-0">
    ...
    <div class="container">
        <div class="cta-counter-wrapper bg-cover" style="background-image: url('assets/img/counter-bg.jpg');">
            <div class="shape-img">
...
<section class="service-section fix section-bg section-padding pt-0" id="services">
...
<!-- About Section Start -->
<section class="about-section-2 fix section-padding pt-0" id="about">
    <div class="bg-shape">
...
<section class="case-studies-section-2 fix section-padding bg-cover" id="projects" style="background-image: url('assets/img/case-studies/bg.jpg');">
    <div class="container">
        <div class="section-title-area">
            <div class="section-title">
                <div class="sub-title bg-color-3 wow fadeInUp">
        ...
        <div class="case-studies-wrapper-2">
            <div class="case-studies-items bor-top bor-bottom">
                ...
                <div class="case-studies-hover d-none d-lg-block bg-cover" style="background-image: url('assets/img/case-studies/hover-img.png');"></div>
            </div>
