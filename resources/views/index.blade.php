...
<html lang="en">
    ...
    <head>
        ...
        <meta name="description" content="Innov Digital - Digital Marketing Agency Html Template">
        <!-- ======== Page title ============ -->
        <title>Innov Digital - Digital Marketing Agency Html Template</title>
        <!--<< Favcion >>-->
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="hero-image">
                            <img src="assets/img/hero/hero-image.png" alt="img" class=" wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                            <div class="bg-shape">
