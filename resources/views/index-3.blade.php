...
<div class="marquee-section section-padding pt-0">
    <div class="mycustom-marque theme-blue-bg">
        <div class="scrolling-wrap">
            <div class="comm">
                <div class="cmn-textslide stroke-text"><img src="{{ asset('img/team/has.png') }}" alt="img">Business Grow</div>
                <div class="cmn-textslide"><img src="{{ asset('img/team/has.png') }}" alt="img">Digital Marketing </div>
                <div class="cmn-textslide stroke-text"><img src="{{ asset('img/team/has.png') }}" alt="img">SEO Marketing</div>
                <div class="cmn-textslide"><img src="{{ asset('img/team/has.png') }}" alt="img">Email Marketingimg</div>
            </div>
            <div class="comm">
                <div class="cmn-textslide stroke-text"><img src="{{ asset('img/team/has.png') }}" alt="img">Business Grow</div>
                <div class="cmn-textslide"><img src="{{ asset('img/team/has.png') }}" alt="img">Digital Marketing </div>
...
<!-- About Section Start -->
<section class="about-section-2 fix section-padding bg-cover" style="background-image: url('img/team/team-bg.jpg');">
    <div class="bg-shape">
