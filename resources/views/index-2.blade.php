...
<!-- Hero Section Start -->
<section class="hero-section hero-2" style="background-image: url('img/hero/hero-bg-2.png');">
    <div class="trophy-shape">
        <img src="{{ asset('img/hero/trophy-shape.png') }}" alt="img">
    </div>
    <div class="left-shape">
        <img src="{{ asset('img/hero/left-shape.png') }}" alt="img">
    </div>
    <div class="right-shape">
        <img src="{{  asset('img/hero/right-shape.png') }}" alt="img">
    </div>
    <div class="rocket-shape float-bob-y">
        <img src="{{ asset('img/hero/rocket-2.png') }}" alt="img">
    </div>
        ...
        <div class="row g-4 justify-content-between align-items-center">
            ...
            <div class="col-lg-5">
                <div class="hero-image">
                    <img src="{{ asset('img/hero/hero-image-2.png') }}" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                    <div class="bg-shape">
                        <img src="{{ asset('img/hero/bg-shape-2.png') }}" alt="img">
                    </div>
                    <div class="box-shape">
                        <img src="{{ asset('img/hero/box-shape.png') }}" alt="img">
                    </div>
                    <div class="gap-shape">
                        <img src="{{ asset('img/hero/gap-box.png') }}" alt="img">
                    </div>
                    <div class="cursor-shape">
                        <img src="{{ asset('img/hero/cursor.png') }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
...
<section class="feature-secton section-padding fix">
    <div class="bg-shape">
        <img src="{{ asset('img/bg-shape-2.png') }}" alt="img">
    </div>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".8s">
                <div class="feature-box-image bg-cover" style="background-image: url('img/feature-bg.jpg');">
                    <img src="{{ asset('img/feature-img.png') }}" alt="img">
                </div>
            </div>
        </div>
    </div>
...
<section class="cta-counter-section fix section-padding pt-0">
    <div class="bg-shape">
        <img src="{{ asset('img/bg-shape.png') }}" alt="img">
    </div>
    <div class="container">
        <div class="cta-counter-wrapper bg-cover" style="background-image: url('img/counter-bg.jpg');">
            <div class="shape-img">
                <img src="{{ asset('img/counter-shape.png') }}" alt="img">
            </div>
            <div class="counter-box-area">
                <div class="counter-text wow fadeInUp" data-wow-delay=".3s">
                    <h2>
                        <span class="count">20.5</span>K
                    </h2>
                    <p>Projects Done</p>
                </div>
                <div class="counter-text wow fadeInUp" data-wow-delay=".5s">
                    <h2>
                        <span class="count">100.5</span>K
                    </h2>
                    <p>Happy Clients</p>
                </div>
                <div class="counter-text wow fadeInUp" data-wow-delay=".7s">
                    <h2>
                        <span class="count">150.5</span>K
                    </h2>
                    <p>Team Members</p>
                </div>
                <a href="about.blade.php" class="circle-button">
                    ...
                    <span class="text-circle">
                        <img src="{{ asset('img/text-circlw.png') }}" alt="">
                    </span>
                </a>
            </div>
        </div>
...
<section class="service-section fix section-bg section-padding pt-0">
    ...
    <div class="container">
        <div class="section-title-area">
            ...
            <div class="main-button wow fadeInUp" data-wow-delay=".3s">
                <a href="service.blade.php"> <span class="theme-btn">EXPLORE MORE </span><span class="arrow-btn"><i class="fa-regular fa-arrow-up-right"></i></span></a>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                <div class="service-card-items">
                    <h3 class="title">
                        <a href="{{ route('service.details') }}">
                            One Page SEO <br> Optimization
                        </a>
                    </h3>
                    <div class="service-thumb">
                        <img src="{{ asset('img/service/02.png') }}" alt="img">
                    </div>
                    <div class="content">
                        <p>
                            Collaboratively formulate principle capital doing progressively evolve user
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                <div class="service-card-items">
                    ...
                    <div class="service-thumb">
                        ...
                        <img src="{{ asset('img/service/03.png') }}" alt="img">
                    </div>
                    <div class="content">
                        <p>
                            Collaboratively formulate principle capital doing progressively evolve user
...
<section class="case-studies-section-2 fix section-padding bg-cover" style="background-image: url('img/case-studies/bg.jpg');">
    <div class="container">
        <div class="section-title-area">
            <div class="section-title">
                <div class="sub-title bg-color-3 wow fadeInUp">
        ...
        <div class="case-studies-wrapper-2">
            <div class="case-studies-items bor-top bor-bottom">
                ...
                <div class="main-button">
                    <a href="{{ route('project.details') }}"> <span class="theme-btn">Get Started </span><span class="arrow-btn"><i class="fa-regular fa-arrow-up-right"></i></span></a>
                </div>
                <div class="case-studies-hover d-none d-lg-block bg-cover" style="background-image: url('img/case-studies/hover-img.png');"></div>
            </div>
            ...
            <div class="case-studies-items bor-bottom">
                <div class="content">
                    <h3><a href="{{ route('project.details') }}">Content Marketing</a></h3>
                    <span>MARKETING</span>
                    <p>
                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humor.
                    </p>
...
<section class="faq-section section-padding pb-0">
    <div class="faq-overlay">
        <img src="{{ asset('img/faq-overlay.png') }}" alt="img">
    </div>
    <div class="faq-shape">
        <img src="{{ asset('img/faq-shape.png') }}" alt="img">
    </div>
    <div class="container">
...
<section class="cta-contact-section fix section-padding">
    <div class="container">
        <div class="cta-contact-wrapper bg-cover" style="background-image: url('img/cta-contact-bg.jpg');">
            <div class="cta-image wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                <img src="{{ asset('img/contact-img.png') }}" alt="img">
            </div>
...
<section class="testimonial-section fix section-padding pt-0 bg-cover" style="background-image: url('img/testimonial/testimonial-bg.jpg');">
    <div class="container">
        <div class="testimonial-wrapper-2">
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="testimonial-image">
                        <img src="{{ asset('img/testimonial/03.png') }}" alt="img" class="wow img-custom-anim-left" data-wow-duration="1.5s" data-wow-delay="0.3s">
                        <div class="rocket-shape">
                            <img src="{{ asset('img/testimonial/rocket.png') }}" alt="img">
                        </div>
                        <div class="msg-shape float-bob-y">
                            <img src="{{ asset('img/testimonial/msg.png') }}" alt="img">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-card-items">
                                        <div class="client-info">
                                            <div class="client-img">
                                                <img src="{{ asset('img/testimonial/04.png') }}" alt="img">
                                            </div>
...
<section class="news-section section-padding fix">
    <div class="left-shape">
        <img src="{{ asset('img/news/left-shape.png') }}" alt="img">
    </div>
    <div class="container">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="news-box-items">
                    <div class="news-image wow img-custom-anim-top" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <img src="{{ asset('img/news/01.jpg') }}" alt="img">
                    </div>
