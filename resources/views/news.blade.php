                ...
                <div class="news-standard-wrapper">
                    <div class="news-standard-items">
                        ...
                        <div class="content">
                            ...
                            <h3><a href="{{ route('news.details') }}">Choose The Best IT Service Company in the City.</a></h3>
                            <p>
                            ...
                            <a href="news-details.blade.php" class="theme-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                        </div>
                    </div>
                    <div class="news-standard-items">
                        <div class="thumb">
                        ...
                        <div class="content">
                            ...
                            <h3><a href="{{ route('news.details') }}">Keep Your Business Safe Ensure High Availability</a></h3>
                            <p>
                                Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum mauris id nunc molestie tincidunt erat gravida. Nullam dui libero, mollis ac quam et, venenatis.
                            </p>
                            <a href="news-details.blade.php" class="theme-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
                    ...
                    <div class="news-standard-items mb-0">
                        <div class="thumb">
                        ...
                        <div class="content">
                            ...
                            <h3><a href="{{ route('news.details') }}">Tackling the Changes of Retell Industry</a></h3>
                            <p>
                                Pellentesque egestas rutrum nibh facilisis ultrices. Phasellus in magna ut orci malesuada the sollicitudin. Aenean faucibus scelerisque convallis. Quisque interdum mauris id nunc molestie tincidunt erat gravida. Nullam dui libero, mollis ac quam et, venenatis.
                            </p>
                            <a href="news-details.blade.php" class="theme-btn">Read More <i class="fa-regular fa-arrow-right-long"></i></a>
